...
e       = oe(2);            %eccentricity
Omega   = deg2rad(oe(3));   %longitude of ascending node
inc     = deg2rad(oe(4));   %orbital inclination
omega   = deg2rad(oe(5));   %argument of the periapsis (rad)
nu      = deg2rad(oe(6));   %true anomaly
